...
export default function ProfilePage() {
  ...
  const getCheckIn = (b) => formatDateToDDMMYYYY(b.checkInDate || b.checkIn);
  const getCheckOut = (b) => formatDateToDDMMYYYY(b.checkOutDate || b.checkOut);
  const getAmount = (b) =>
    b.totalAmount ?? b.amount ?? b.total ?? 0;
  const getStatus = (b) => b.status || "Confirmed";
